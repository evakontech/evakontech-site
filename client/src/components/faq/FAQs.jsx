        ...
        <section className="mx-auto max-w-7xl px-2 py-10 m- md:px-0">
            <div>
                ...
                <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16">
                    <div
                        className={`cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200 ${expandedIndex === 0 ? 'border-blue-500' : ''}`}
                    >
                        <button
                            type="button"
                        ...
                        {expandedIndex === 0 && (
                            <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                                <p className="text-gray-500">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat aliquam adipisci iusto aperiam?
                                    Sint asperiores sequi nobis inventore ratione deleniti?
                                </p>
                            </div>
                        )}
                    </div>
                        ...
                        >
                            ...
                            {expandedIndex === i + 1 && (
                                <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                                    {i === 0 && (
                                        <p className="text-gray-500">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat aliquam adipisci iusto
                                            aperiam? Sint asperiores sequi nobis inventore ratione deleniti?
                                        </p>
                                    )}
                                    {i === 1 && (
                                        <p className="text-gray-500">
